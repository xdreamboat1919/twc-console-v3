...
async function startConsole() {
  ...
  renderAll();
  if (!restored && typeof workspaceAudit === 'function')
    workspaceAudit('Workspace', 'Production workspace initialized', 'Campaign Console 2.0');
  if (window.TWC && TWC.store) {
    TWC.store.watch();
    TWC.store.schedule(restored ? 'workspace restored' : 'workspace initialized');
  }
}
startConsole();
