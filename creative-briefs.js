/* ================= BRIEFS ================= */
var BRIEFS=[
 {c:'ind',id:'IND-01',n:'The shelf',h:'There\u2019s a shelf in my house I hope I never open.',
  ...
  cta:'Learn more',d:'LP-02',ac:'AC-03',
  note:'No outcome implied. The tension is entirely in "hope I never," which is anticipation rather than a claim.'},
 {c:'ind',id:'IND-02',n:'The cabinet audit',h:'Most medicine cabinets hold three things.',sub:'Painkillers, plasters, and something expired.',
  v:'Split frame. Left, cluttered typical cabinet with expired boxes. Right, the kit, closed.',
  p:'Ours did too. Then we actually looked.',cta:'Learn more',d:'LP-02',ac:'AC-01',
  note:'Observational about the category, never about the viewer. "Most cabinets" and not "your cabinet."'},
 {c:'ind',id:'IND-03',n:'Distance',h:'41 minutes to the nearest 24-hour pharmacy.',
  v:'Night map aesthetic. A pin, a route line, a time.',
  p:'That\u2019s the actual number where I live. Worth knowing yours.',cta:'Learn more',d:'LP-02',ac:'AC-11',
  note:'Pure logistics. The safest problem framing available for this product.'},
 {c:'ind',id:'IND-04',n:'Authorship',h:'Five physicians decided what goes in this box.',
  ...
  cta:'See the contents',d:'LP-01',ac:'AC-02',
  note:'Physician claims sit in the review-required tier. Approve before production, not after.'},
 {c:'ind',id:'IND-05',n:'The reframe',h:'Preparedness isn\u2019t paranoia.',sub:'It\u2019s just admitting logistics exist.',
  v:'Kit on a kitchen counter beside ordinary items. Bright, domestic, unremarkable.',
  p:'Pharmacies close. Weekends happen. That\u2019s the whole argument.',cta:'Learn more',d:'LP-02',ac:'AC-11',
  note:'Directly disarms the main objection to this category. Test against IND-01 for the same slot.'},
 {c:'ind',id:'IND-06',n:'Contents walkthrough',h:'Here\u2019s exactly what\u2019s inside.',
  ...
  cta:'See the full contents',d:'LP-01',ac:'AC-01, AC-04',
  note:'Lowest-risk asset in the deck. Showing contents is factual. Keep this live as the safe default.'},
 {c:'ind',id:'IND-07',n:'Scale',h:'1,000,000+',sub:'Americans have one of these.',
  v:'Kit, understated, large numeral treatment.',
  p:'Turns out a lot of people had the same thought.',cta:'Learn more',d:'LP-02',ac:'AC-07',
  note:'Social proof by count. Verify the figure is currently substantiated before running.'},
 {c:'ind',id:'IND-08',n:'Time',h:'Bought it in March.',sub:'Opened it in November.',
 ...
 {c:'dir',id:'DIR-01',n:'The straight offer',h:'The Medical Emergency Kit',sub:'$299.99 · Free US shipping',
  ...
  cta:'Get the kit',d:'LP-01',ac:'AC-01, AC-05, AC-09'},
 {c:'dir',id:'DIR-02',n:'Rating',h:'4.9 stars. 2,006 reviews.',
  v:'Product with review stars and count, prominent.',
  p:'Our most-reviewed product, by a distance.',cta:'See why',d:'LP-01',ac:'AC-08',
  note:'Star rating and count only. No review text on the image, because review text is where claims enter.'},
 {c:'dir',id:'DIR-03',n:'Certification',h:'LegitScript Certified.',sub:'Prescribed by licensed providers.',
 ...
 {c:'cmp',id:'CMP-01',n:'Cabinet vs kit',h:'What most people have. What\u2019s in the kit.',
  ...
  cta:'See the full contents',d:'LP-01',ac:'AC-01',note:'Contents versus contents. Factual on both sides.'},
 {c:'cmp',id:'CMP-02',n:'Which kit',h:'Six kits. One of them is the right one.',
  ...
  cta:'Find your kit',d:'LP-03',ac:'AC-01',note:'Drives the selector. Non-clinical inputs only.'},
 {c:'cmp',id:'CMP-03',n:'Tier comparison',h:'Medical. Contagion. Travel.',sub:'Same idea, three different situations.',
  v:'Three kits, escalating, with contents counts.',
  p:'The difference is what\u2019s inside and where you\u2019re likely to need it.',
  cta:'Compare',d:'LP-03',ac:'AC-01',
  note:'Product tiers only. Never compare a kit to a medication or to a course of care.'},
 {c:'cmp',id:'CMP-04',n:'Getting there',h:'Getting there. Or already having it.',
 ...
 {c:'lofi',id:'LOFI-01',n:'Notes app',h:'(image carries it)',
 ...
 {c:'lofi',id:'LOFI-05',n:'Text thread',h:'(image carries it)',
  ...
  p:'The best purchases are the ones you forget about.',cta:'Learn more',d:'LP-02',ac:'AC-03',
 ...
 {c:'lofi',id:'LOFI-08',n:'Packing',h:'(no headline)',
  ...
  cta:'Learn more',d:'LP-03',ac:'AC-01',note:'Routes to the selector, since this frames the Travel Kit specifically.'}
];
var BRDESC={
...
function renderBriefs(){
  ...
  var list=brKey==='all'?BRIEFS:BRIEFS.filter(function(b){return b.c===brKey});
  $('br-list').innerHTML=list.map(function(b){
    return '<div class="panel" style="margin-bottom:12px;padding:16px 18px">'+
      '<div class="row" style="justify-content:space-between;margin-bottom:10px">'+
      '<span style="font-family:var(--mono);font-size:13px;font-weight:650;color:var(--act)">'+b.id+'</span>'+
      '<span style="font-size:13px;color:var(--ink-3)">'+b.n+'</span></div>'+
      '<div style="font-size:17px;font-weight:640;line-height:1.35;margin-bottom:'+(b.sub?'2px':'10px')+'">'+b.h+'</div>'+
      (b.sub?'<div style="font-size:15px;color:var(--ink-2);margin-bottom:10px">'+b.sub+'</div>':'')+
      '<div class="tw"><table><tbody>'+
      '<tr><td style="width:110px;color:var(--ink-3);font-size:12.5px">Visual</td><td style="font-size:13px">'+b.v+'</td></tr>'+
      '<tr><td style="color:var(--ink-3);font-size:12.5px">Primary text</td><td style="font-size:13px">'+b.p+'</td></tr>'+
      '<tr><td style="color:var(--ink-3);font-size:12.5px">CTA</td><td style="font-size:13px">'+b.cta+'</td></tr>'+
      '<tr><td style="color:var(--ink-3);font-size:12.5px">Destination</td><td style="font-size:13px;font-family:var(--mono)">'+b.d+'</td></tr>'+
      '<tr><td style="color:var(--ink-3);font-size:12.5px">Claim ref</td><td style="font-size:13px;font-family:var(--mono)">'+b.ac+'</td></tr>'+
      '</tbody></table></div>'+
      (b.note?'<div class="note'+(b.note.indexOf('CRITICAL')===0?' bad':'')+'" style="margin-top:10px">'+b.note+'</div>':'')+
      '</div>';
  }).join('');
}
$('br-tabs').addEventListener('click',function(e){
  var b=e.target.closest('.tab'); if(!b)return;
  Array.prototype.forEach.call($('br-tabs').children,function(x){x.classList.remove('on')});
  b.classList.add('on'); brKey=b.dataset.b; renderBriefs();
});
